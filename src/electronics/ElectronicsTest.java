...
public class ElectronicsTest extends Utility {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        //2.20 Fill the mandatory fields
        sendTextToElement(By.id("FirstName"), "Kajol");
        sendTextToElement(By.id("LastName"), "Oja");
        sendTextToElement(By.id("Email"), "kajaloja12@gmail.com");
        sendTextToElement(By.id("Password"), "Temp@12");
        sendTextToElement(By.id("ConfirmPassword"), "Temp@12");
