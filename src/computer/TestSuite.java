...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        //2.22 Fill the all mandatory field
        sendTextToElement(By.id("BillingNewAddress_FirstName"), "Cristina");
        sendTextToElement(By.id("BillingNewAddress_LastName"), "Rusu");
        sendTextToElement(By.id("BillingNewAddress_Email"), "cristinarusu0@gmail.com");
        sendTextToElement(By.id("BillingNewAddress_Company"), "TC Limited");
        selectByVisibleTextFromDropdown(By.id("BillingNewAddress_CountryId"), "United Kingdom");
        sendTextToElement(By.id("BillingNewAddress_City"), "London");
        sendTextToElement(By.id("BillingNewAddress_Address1"), " Coral Street");
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"), "HA62QN");
        ...
        //2.28 Fill all the details
        sendTextToElement(By.id("CardholderName"), "Hiral Sutariya");
        ...
        String actualShipping = getTextFromElement(By.xpath("//li[@class='payment-method']"));
